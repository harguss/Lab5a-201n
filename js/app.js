...
Write a function called multiply()
 that takes in two numbers as arguments and returns an array where the first element is the product of those numbers, and the second element is a string that EXACTLY follows this example and uses the values that were input into the function:
...
//              1       2
  ...
  let stringTwo = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + product + '.';

  // console.log([sumTotal, product, stringOne, stringTwo]);

  return[sumTotal, product, stringOne, stringTwo];
...
function sumArray(sumArr) { //eslint-disable-line
  let sumArray =  sum(sumArr[0], sum(sumArr[1], sumArr[2])[0])[0];
  // console.log('what is our sum ',sumArray);
